...
$sql=mysql_query("SELECT * FROM doctor_reg WHERE password='$in'")or die("could not select staff table".mysql_error());
...
$rows=mysql_fetch_array($sql);
		...
		if(isset($_POST["update"])){
			...
			$user=$_POST["user"];
            $a=$_SESSION['tmp'];
$sql=mysql_query ("UPDATE doctor_reg SET surname='$sname', firstname='$fname', othername='$Oname', phone='$phone', username='$user'  WHERE password='$a'") or die("Failed to update record!");
...
<body>
 ...
 <li role="presentation"><a href="Update_Rec.php">Receptionist account</a>
    ...
    <div class="col-md-12">
        <h1 class="text-center">Doctor Profile</h1></div>
     ...
     <input type="text" name="password" placeholder="Enter staff password" class="form-control input-lg" />
       <button class="btn btn-primary" name="check" type="submit" style="margin: 10px;">Submit </button>
                   ...
                   <h3 class="text-muted text-center">Doctor Information Update</h3>
                            <div class="form-group">
