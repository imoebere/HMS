...
if(isset($_POST['register']))
{
	...
	$select= "select * from doctor_reg where username = '$username'";
	...
	if ($num>0){
        ...
        $username=$_POST['uname'];
		$phone = $_POST['phone'];
		$password = 'DOC'.rand(1000,100000);
$insert= mysql_query("insert into doctor_reg values('','$surname','$firstname','$othername','$phone','$username','$password', now())")or die("could not insert into reg table".mysql_error());
