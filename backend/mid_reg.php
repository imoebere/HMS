...
if(isset($_POST['register']))
{
	...
	$select= "select * from mid_reg where username = '$username'";
	...
	if ($num>0){
        ...
        $username=$_POST['uname'];
		$phone = $_POST['phone'];
		$password = 'MID'.rand(1000,100000);
$insert= mysql_query("insert into mid_reg values('','$surname','$firstname','$othername','$phone','$username','$password', now())")or die("could not insert into reg table".mysql_error());
	...
	if (!@$insert) {
		...
		$_SESSION['don'] = $password;
                                            ...
                                            var pin=<?php echo $password; ?>;
         alert("record completed successfully!!, your password is:" + " " + pin);window.location='index.php';</script>
											<?php
                                           
                                        
                                    

        echo "<div role='alert' class='alert alert-success' id='alert' >
    <button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>×</span></button><span>Staff Registration Successful!</span></div>";
    }
}
}
?>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navcol-2">
            <ul class="nav navbar-nav">
                ...
                <li role="presentation"><a href="index.php">Logout <?php include 'logout.php'; ?></a></li>
            </ul>
        </div>
    </div>
</nav>
                ...
                <div class="row register-form">
                    <div class="col-md-10 col-md-offset-1">
                        <form class="form-horizontal custom-form"  method="post">
                            <h1>Midwife Registration Form</h1>
